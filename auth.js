...
function showFatal(message) {
  document.body.innerHTML = `
    <div style="display:flex;align-items:center;justify-content:center;min-height:100vh;background:#F5F3EF;font-family:'Noto Sans JP',sans-serif;padding:20px;">
      <div style="background:#fff;border-radius:14px;border:1px solid #E5E0D8;padding:36px 32px;text-align:center;max-width:400px;box-shadow:0 4px 20px rgba(0,0,0,0.06);">
        <div style="font-size:30px;margin-bottom:14px;">🔒</div>
        <div style="font-size:15px;font-weight:700;color:#3A342B;margin-bottom:8px;">アクセスできません</div>
        <div style="font-size:13px;color:#8A8378;line-height:1.7;margin-bottom:22px;">${message}</div>
